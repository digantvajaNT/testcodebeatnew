                            ...
                            <div class="topbar-contact-info-wrapper">
                                <div class="topbar-contact-info">
                                    <div>
                                        ...
                                        <div class="details">
                                            <p>B/1, Shantam Complex, Navrangpura</p>
                                        </div>
                                    </div>
                                    <div>
                            ...
                            <div class="text-right">
                                <div class="navlinksproducts">
                                    <ul>
                                        ...
                                        <li>
                                            <a href="javascript:;"> 
                                                <span>Product Display Center</span>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
...
<!--                            <li><a href="#">Our Products</a></li>-->
                            ...
                            <li><a href="#">Alkaline Products</a></li>
                            <li><a href="#testimonialsmain" class="testimoniallink">Testimonials</a></li> 
                            <li>
                                <a href="#">FAQ</a>
                            </li>
...
-->
                    ...
                    <a href="javascript:;" class="theme-btn-s2 request-quote search_btn"><i class="fa fa-search" aria-hidden="true"></i></a> 
