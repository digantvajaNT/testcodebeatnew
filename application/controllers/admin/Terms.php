...
class Terms extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['title'] = $this->config->item('site_name').' - Terms';
        $data['page_data'] = $this->Pages_model->get_page('page_slug','terms');
        if ($this->input->post())
        {
			...
			if(!empty($sTitle) && !empty($sContent)) {
	            ...
	            $this->Pages_model->update_page('page_slug','terms',$post_data);
        ...
        $this->load->view('admin/content_pages/terms', $data);
