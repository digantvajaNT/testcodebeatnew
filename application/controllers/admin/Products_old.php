...
class Products extends CI_Controller {
    ...
    public function add() {
        ...
        if ($this->input->post()) {
            ...
            $product_isFeatured = $this->security->xss_clean($this->input->post("product_isFeatured"));
            ...
            $arrProduct = array(
                ...
                "product_isFeatured" => $product_isFeatured,
    ...
    public function edit($iListId) {
        ...
        if ($this->input->post()) {
         ...
         //   $this->Products_model->update_product($iListId, $arrProduct, '_rds_products');
            ...
            $this->session->set_flashdata('product', array('message' => 'Product updated successfully.', 'icon' => 'icon fa fa-check', 'class' => 'alert alert-success alert-dismissible'));
            redirect('admin/products');
        }
        $this->load->view('admin/templates/header', $data);
        $this->load->view('admin/templates/sidebar');
    ...
    public function update_draft($iListId) {
        ...
        if ($this->input->post()) {
            ...
            if ($sProductStatus == 'active') {
                $this->session->set_flashdata('product', array('message' => 'Portfolio published successfully.', 'icon' => 'icon fa fa-check', 'class' => 'alert alert-success alert-dismissible'));
                redirect('admin/products');
            } else {
    ...
    public function delete($iListId) {
        if ($iListId) {
            ...
            $this->session->set_flashdata('product', array('message' => 'Portfolio Deleted Successfully.', 'icon' => 'icon fa fa-check', 'class' => 'alert alert-danger alert-dismissible'));
            redirect('admin/products');
        }
    }
    ...
    public function update_order() {
        if ($this->input->post()) {
            ...
            $this->session->set_flashdata('product', array('message' => 'Portfolio reordered successfully.', 'icon' => 'icon fa fa-check', 'class' => 'alert alert-success alert-dismissible'));
        }
    }
