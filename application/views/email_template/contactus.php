...
<table width="100%" border="0" align="center" cellpadding="15" cellspacing="0" bgcolor="#FAFAFA" style="max-width: 600px; font-family:'HelveticaNeue-Light', 'Helvetica Neue Light', 'Helvetica Neue', Helvetica, Arial, 'Lucida Grande', sans-serif;color: #000;font-weight: normal;line-height: 1.6;font-size: 14px;border-radius:0px 0px 3px 3px;">
    ...
    <tr>
        <td style="border:1px solid #f0f0f0;border-bottom:1px solid #c0c0c0;"><h3 style="margin:0px;margin-bottom: 15px;font-size: 24px;line-height: 1.1;font-weight: 500;"> Hi, </h3>
            <p style="margin:0px 0px 10px 0px;">Please find below contact inquiry details.</p>
           	<p style="margin:0px 0px 10px 0px;">Contact person details:</p>
           	<p style="margin:0px 0px 10px 0px;">Full Name: <?php echo $form_data["tb_person_name"];?></p>
           	<p style="margin:0px 0px 10px 0px;">Email address: <?php echo $form_data["tb_person_email"];?></p>
           	<p style="margin:0px 0px 10px 0px;">Contact Number: <?php echo $form_data["tb_person_contactno"];?></p>
           	<p style="margin:0px 0px 10px 0px;">Organization: <?php echo $form_data["tb_organization"];?></p>
           	<p style="margin:0px 0px 10px 0px;">Message: <?php echo $form_data["tb_message"];?></p>
