...
<div class="content-wrapper">
    ...
    <section class="content">
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="box box-info">
                            ...
                            echo form_open_multipart('admin/Store_Locator/edit/'.$iListId,$attributes);
                            ?>
                            <div class="box-body">
		...
		<div class="form-group">
									...
									<div class="col-sm-10">
                               <input type="text" class="form-control" value="<?php echo $area_data['tb_name'];?>" name="tb_Areaname" id="tb_Areaname"  maxlength="50">
