        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <?php
                    if ($this->session->flashdata('services')) {
                        $message = $this->session->flashdata('services');
                        ?>
                                ...
                                if (count($bod_data) > 0) {
                                    foreach ($bod_data as $iRow) {
                                        ...
                                        <tr>
                                            ...
                                            <td> 
                                                <a data-toggle="tooltip" title="Edit" class="btn btn-default btn-xs" href="<?php echo site_url('admin/services') . '/edit/' . $iRow['id']; ?>"><em class="fa fa-pencil"></em></a>
            ...
            $.confirm({
                ...
                buttons: {
                    confirm: {
                        ...
                        keys: ['enter', 'shift'],
                        action: function () {
                            window.location.href = '<?php echo site_url('admin/services') . '/delete/'; ?>' + id;
                        }
                    },
                    cancel: {
                        text: 'Cancel',
