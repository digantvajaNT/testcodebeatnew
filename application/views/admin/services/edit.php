                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="box box-info">
                            ...
                            echo form_open_multipart('admin/services/edit/'.$iListId,$attributes);
                            ?>
							...
							<div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" value="<?php echo $category_data[0]['name'];?>" name="name" id="name"  maxlength="50">
                                        </div>
                                    </div>
								...
								<div class="box-body">
								 ...
								 <textarea type="text" class="form-control editor" name="description" id="description" required ><?php echo $category_data[0]['description'];?></textarea>
                               			  ...
                               			  <div class="box-body">
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">Service Image<span class="text-danger">*</span></label>
                                        <div class="col-sm-10">
										<input type="file" name="file_newsimage" id="file_newsimage" class="form-control"/>
                                        </div>
                                    </div>
								<?php if($category_data[0]["image_service_url"] != '') { ?>
                                	<a href="<?php echo base_url().'uploads/home/'.$category_data[0]["image_service_url"]?>" target="_blank" class="btn btn-xs bg-navy">View image</a>
                            	<?php } ?>
                                </div>
								
								<div class="box-body">
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">Home Service Image<span class="text-danger">*</span></label>
                                        <div class="col-sm-10">
										<input type="file" name="ddfile_newsimage" id="ddfile_newsimage" class="form-control"/>
                                        </div>
                                    </div>
								<?php if($category_data[0]["home_image"] != '') { ?>
                                	<a href="<?php echo base_url().'uploads/front/'.$category_data[0]["home_image"]?>" target="_blank" class="btn btn-xs bg-navy">View image</a>
                            	<?php } ?>
                                </div>
