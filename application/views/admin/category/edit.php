                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="box box-info">
                            ...
                            echo form_open_multipart('admin/category/edit/'.$iListId,$attributes);
                            ?>
                            <div class="box-body">
							<div class="form-group">
                                    <label class="col-sm-2 control-label">Main Category<span class="text-danger">*</span></label>
									<div class="col-sm-10">
                                    <select class="form-control select2" name="dd_maincategory" id="dd_category" multiple="multiple" data-placeholder="Select a Main Category" >
									<?php 
                                                if($category_data['ManuCtegory_id'] == 1) {
                                                    $sSeltected = 'selected = "selected"';
                                                }elseif($category_data['ManuCtegory_id'] == 2){
													$sSeltected1 = 'selected = "selected"';
												}elseif($category_data['ManuCtegory_id'] == 3){
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" value="<?php echo $category_data['category_name'];?>" class="form-control" name="tb_categoryname" id="tb_categoryname">
                                    </div>
                                </div>
									...
									<div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" value="<?php echo $category_data['category_description'];?>"name="category_description" id="category_description"  >
                                        </div>
                                    </div>
                            </div>
                            <!-- /.box-body -->
